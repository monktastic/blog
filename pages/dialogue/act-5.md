...
> *For quantum mechanics ... all we really have to do (most
people believe) is think about it in the right way. No elaborate
experiments necessarily required (although they could help nudge us in
the right direction, no doubt about that). But if anything, that makes
the embarrassment more acute. All we have to do is wrap our brains
around the issue, and yet we’ve failed to do so.*
>
> &nbsp;
>
...
as one of the "orthodox rules?"

**Bob**: Oh, no. The idea of a "collapse" is far from accepted. You can
think of it as one of many shoehorned interventions we've invented to
avoid the absurd conclusion I'm about to show you.
...
**Bob**: It is virtually impossible *in practice*, yes, but nothing so
far suggests that it is impossible *in theory*. This difference may
seem trivial -- and it *is* for the practicing physicist -- but it in
no way resolves the fundamental problem. Believing so is a common
misconception[2]. Though we are a far cry from a cat, we *have* done
such experiments on macroscopic objects[3], and see no fundamental
limits yet.
...
**Bob**: Yes, yes, Eugene Wigner tried this, too. It is
weird to think of a live human as being in a superposition, so maybe
conscious creatures collapse the wave function[4]. But let us avoid such
woo here! If the cat is dead, your friend sees that; if it is alive,
she sees that; both possibilities are still in superposition.
...
But it gets worse: even if I discover now that the cat *has been dead*
for some time, *that* wasn't true a moment ago. The *history* of the
cat's fate comes into being in that moment. But then the past isn't
what I think it is. It's more like a back-story concocted to explain
the present.
...
my brain contains no trace of it[7]? Is the cat's fate "reset" for me?
I know I'm going way beyond our limited experimental data, but it is one
relatively straightforward extrapolation -- assuming you don't have any
metaphysical pre-commitments!

**Alice**: We will come back to this "forgetting" thing later. But what
does this all tell you?

**Bob**: Well, it's obvious *why* we yearn for some explanation -- be it
collapse, decoherence, many worlds, the consciousness of others, or
a thousand others -- to get us out of this mess. For all I know, one
of them will, and make a fool out of me. But part of me suspects that
isn't true... and, moreover, suspects that the physics community quietly
agrees.
...
Either way, this perspective seems to be doing something useful for me.
When I confront it very squarely -- like you made me do for the "time
as an illusion" idea -- I end up in the same strange space as before.
My worldview briefly shatters.
...
[2] [Decoherence](https://en.wikipedia.org/wiki/Quantum_decoherence) is
...
that it is there *in theory*.

> "Whenever a quantum system gets entangled with another system, its
coherence is reduced. However, the term 'decoherence' is typically
reserved to situations in which the loss of coherence is **effectively**
permanent and **difficult** to reverse or avoid."
...
This is also the heart of the misunderstanding of the double-slit
experiment and whether arbitrary physical systems can be called
"measuring devices." For more, see [here](quantum-bleep.html).
...
aka "consciousness causes collapse." As we saw from the opening quotes,
Wigner recognized fully well what would happen if he did *not* inject
this kind of deus ex machina.
...
based on a vague notion of "worlds"; the state vector contains all
the information we need. And if you are *not* entangled with it, then
you are still capable of demonstrating the superposition, no matter the
interpretation regarding "worlds."

Another common argument is that there are still two answers *after* you
see it (with each copy of you seeing a different answer). But while this
"God's-eye view" may be true, it is irrelevant to (any copy of) you.
...
two cases. If you were asleep when you "saw" the cat, and your brain
doesn't have reliable information, then you can treat it almost the same
...
[here](https://physics.stackexchange.com/a/35049/118804). Whether it
applies to brains in the way described is, as usual, far beyond our
current ability to demonstrate.
